...
rFocus = 10000e3;      % Focal radius, transducer [m]
...
figure(2); % Display the current plot (ensure this is your wave field plot)

disp('Click on the -6 dB points at 10 mm depth');
[x_10mm, ~] = ginput(2);  % Capture two points along the -6 dB contour line at depth 10 mm
